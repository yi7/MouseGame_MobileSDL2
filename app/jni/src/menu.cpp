...
void menu_initialize_mouse_select_window()
{
    ...
    select_window->update = menu_update_mouse_select_window;
...
void menu_initialize_cat_select_window()
{
    ...
    select_window->background = select_background;
    select_window->draw = menu_draw_window;
    select_window->update = menu_update_cat_select_window;
...
void menu_initialize_tile_select_window()
{
    ...
    select_window->background = select_background;
    select_window->draw = menu_draw_window;
    select_window->update = menu_update_tile_select_window;
